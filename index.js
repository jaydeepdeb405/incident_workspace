...
function _uploadBundledScript(bundleData) {
    return _postRequest(`/api/488924/nowreact/script/${servicenowConfig.REGISTRY_ID}`, { script: escape(bundleData) }, DEFAULT_CONFIG);
}

function _createDBImageRecords(images) {
    return _postRequest(`/api/488924/nowreact/images?overwrite=${servicenowConfig.OVERWRITE_IMAGE_ATTACHMENTS}`, { images }, DEFAULT_CONFIG);
}
